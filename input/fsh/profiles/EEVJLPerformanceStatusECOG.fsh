Profile: EEVJLPerformanceStatusECOG
Parent: Observation
...
* valueCodeableConcept from https://fhir.ee/ValueSet/ecog-skaala
* valueCodeableConcept ^short = "Placeholder, loend snomed või loinc koodidest"
