...
| Draft as of 2026-09-14 | *Computable Name*:EEVJL |
...
```json
{
  ...
  {
    "id" : "ee_fhir_spd",
    "uri" : "https://fhir.ee/spd/ImplementationGuide/ee.fhir.spd",
    "packageId" : "ee.fhir.spd",
    "version" : "current"
  }],
  "definition" : {
    "extension" : [{
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-ee-vjl-primary-cancer-diagnosis.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/ee-vjl-primary-cancer-diagnosis"
      },
      "name" : "EE VJL Primary Cancer Diagnosis ",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-ee-vjl-tnm.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/ee-vjl-tnm"
      },
      "name" : "EE VJL TNM",
