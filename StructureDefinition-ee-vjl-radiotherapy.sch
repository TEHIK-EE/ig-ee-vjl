...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/vjl/StructureDefinition/ee-vjl-radiotherapy-dose']) &gt;= 1">extension with URL = 'https://fhir.ee/vjl/StructureDefinition/ee-vjl-radiotherapy-dose': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/vjl/StructureDefinition/ee-vjl-radiotherapy-dose']) &lt;= 1">extension with URL = 'https://fhir.ee/vjl/StructureDefinition/ee-vjl-radiotherapy-dose': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:used) &lt;= 0">used: maximum cardinality of 'used' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Procedure/f:reason</sch:title>
    <sch:rule context="f:Procedure/f:reason">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Procedure/f:reason/f:concept</sch:title>
    <sch:rule context="f:Procedure/f:reason/f:concept">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:coding) &gt;= 1">coding: minimum cardinality of 'coding' is 1</sch:assert>
      <sch:assert test="count(f:coding) &lt;= 1">coding: maximum cardinality of 'coding' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
